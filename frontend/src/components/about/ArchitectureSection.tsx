        ...
        <section className="max-w-[1100px] mx-auto px-6 mb-32">
            <GlassPanel className="p-12 border border-[rgba(255,255,255,0.6)] bg-[var(--c-white-glass)]">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="font-sans text-xs uppercase tracking-[0.2em] text-[var(--t-secondary)] mb-6">Architecture</h2>
                    <h3 className="text-4xl font-light text-[var(--t-primary)] mb-8 font-serif">subtitle</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="p-6 text-center">
                        ...
                        <h4 className="font-sans text-sm uppercase tracking-wide font-semibold text-[var(--t-primary)] mb-3">title</h4>
                        <p className="text-sm text-[var(--t-secondary)] font-light">description</p>
                    </div>
                    <div className="p-6 text-center">
                        <div className="w-12 h-12 bg-[rgba(61,124,184,0.1)] rounded-full flex items-center justify-center mx-auto mb-6 text-[var(--c-blue-azure)]">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <h4 className="font-sans text-sm uppercase tracking-wide font-semibold text-[var(--t-primary)] mb-3">title'</h4>
                        <p className="text-sm text-[var(--t-secondary)] font-light">desc</p>
                    </div>
                    <div className="p-6 text-center">
                        <div className="w-12 h-12 bg-[rgba(61,124,184,0.1)] rounded-full flex items-center justify-center mx-auto mb-6 text-[var(--c-blue-azure)]">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
