    ...
    return (
        <section className="max-w-[1200px] mx-auto px-6 mb-40">
            <div className="text-center mb-16">
                <h3 className="text-5xl font-light text-[var(--t-primary)] mb-6 font-serif">inquire</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
                ...
                <GlassPanel className="p-12 flex flex-col items-center text-center !bg-white/40 border border-white/60 hover:shadow-2xl transition-all group">
                    ...
                    <h4 className="text-2xl font-serif text-[var(--t-primary)] mb-4">Host Property</h4>
                    ...
                    <Link href="/dashboard/list-property" className="w-full">
                        <Button className="w-full py-4 rounded-xl text-[10px] tracking-[0.2em]">List Property</Button>
                    </Link>
                </GlassPanel>
                ...
                <GlassPanel className="p-12 flex flex-col items-center text-center !bg-white/40 border border-white/60 hover:shadow-2xl transition-all group">
                    ...
                    <h4 className="text-2xl font-serif text-[var(--t-primary)] mb-4">Explore Properties</h4>
                    <p className="text-sm text-[var(--t-secondary)] font-sans mb-10 leading-relaxed opacity-70">
                        traveler description
                    </p>
                    <Link href="/collection" className="w-full">
                        <Button variant="outline" className="w-full py-4 rounded-xl text-[10px] tracking-[0.2em]">Browse Collection</Button>
                    </Link>
                </GlassPanel>
            </div>
            ...
            <div className="flex flex-col items-center pt-8 border-t border-black/5">
                <div className="flex items-center gap-3 text-[var(--t-secondary)] mb-4">
                    ...
                    <span className="font-sans text-[10px] uppercase tracking-[0.3em] font-bold opacity-60">contact</span>
                </div>
                <a
